  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:title"
          content="Own Your Contents | BlockPen"
          key="og_title"
        />
        ...
        <meta
          name="description"
          content="Own Your Contents powered by BlockPen."
          key="description"
        ></meta>
        <meta
        ...
        <div className="antialiased">
          <div className="min-h-screen flex">
            ...
            <main className="grow overflow-hidden">
              ...
              <Hero
                title="Own Your Contents!"
                description="Connect, create, and monetize with BlocPen."
              />
